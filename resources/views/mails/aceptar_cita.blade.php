    ...
    <body>
        ...
        <div class="container box" style="width: 970px">
            ...
            <p style="padding: 20px">
                ...
                WEB: www.saludintegra.duckdns.com
            </p>
            <br />
            <br />
        </div>
        <div class="container box" style="width: 970px; text-align: center">
            ...
            <p style="padding: 30px; font-size: x-small">
                Todos los datos de nuestros pacientes son confidenciales y su
                información están protegidas, consulte nuestro aviso de
                privacidad en www.saludintegra.duckdns.com
            </p>
        </div>
    </body>
</html>
